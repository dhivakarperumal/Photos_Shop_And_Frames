...
const Billing = () => {
  ...
  return (
    <div className={`min-h-screen bg-[#f3f4f6] p-4 text-[#1f2937] md:p-6 ${selectedOrder?.id ? "" : "no-selected-order"}`}>
      <div className="mx-auto max-w-[1500px]">
        <style>{`.no-selected-order .billing-details-panel { display: none; }`}</style>
