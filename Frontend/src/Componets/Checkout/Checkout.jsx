      ...
      <main className="min-h-screen bg-[#f7f3ed]">
        ...
        <div className="">
          <div className="rounded-3xl border border-[#ebe3d7] bg-white p-6 text-center shadow-lg sm:p-10">
            <PageContainer>
              {/* <div className="mb-5 flex h-20 w-20 items-center justify-center rounded-full bg-[#e8f6ed] text-[#1b794b] shadow-inner">
    ...
    return (
      <main className="min-h-screen bg-[#f7f3ed]">
        ...
        <PageContainer className="py-16 text-center">
          <div className="rounded-3xl border border-[#e8dfd2] bg-white p-10 shadow-xs">
            ...
            <div className="space-y-6 lg:col-span-7">
              ...
              <div className="rounded-3xl border border-[#ebe3d7] bg-white p-6 shadow-sm sm:p-7">
                ...
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                  {/* CASH ON DELIVERY */}
                  <label
                    className={`flex cursor-pointer items-center justify-between rounded-2xl border p-4 transition ${formData.payment_method === "Cash On Delivery"
                  ...
                  {/* ONLINE PAYMENT */}
                  <label
                    className={`flex cursor-pointer items-center justify-between rounded-2xl border p-4 transition ${formData.payment_method === "Online Payment / UPI"
                        ? "border-[#1a3c36] bg-[#f0f6f3] ring-1 ring-[#1a3c36]"
                        : "border-[#e5dfd4] bg-[#faf8f5] hover:border-[#d4a553]"
                      }`}
                  >
